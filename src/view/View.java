...
public class View extends JFrame {
	...
	public JTextField textField_TotalVex;

	/**
	 * Create the frame.
	 */
	public View() {
		this.model = new DirGraph();
		...
		btnOpen.setBackground(UIManager.getColor("CheckBoxMenuItem.selectionBackground"));
		btnOpen.setFont(new Font("Times New Roman", Font.BOLD, 13));
		btnOpen.setBounds(484, 7, 127, 32);
		...
		btnAddVex = new JButton("Thêm đỉnh");
		btnAddVex.setForeground(SystemColor.control);
		btnAddVex.setFont(new Font("Times New Roman", Font.BOLD, 13));
		btnAddVex.setBackground(SystemColor.textHighlight);
		btnAddVex.setBounds(578, 73, 174, 32);
		panel_1.add(btnAddVex);

		btnAddVex.addActionListener(ac);
		...
		JLabel lbl_TotalVex = new JLabel("Số đỉnh:");
		lbl_TotalVex.setFont(new Font("Times New Roman", Font.BOLD, 18));
		lbl_TotalVex.setBounds(496, 292, 76, 30);
		contentPane.add(lbl_TotalVex);
		
		textField_TotalVex = new JTextField();
		textField_TotalVex.setBounds(572, 287, 57, 30);
		contentPane.add(textField_TotalVex);
		textField_TotalVex.setColumns(10);
